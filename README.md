...
> Відкрити цю сторінку в [https://dzeshiko.github.io/sometest/](https://dzeshiko.github.io/sometest/)
...
* шукайте **https://github.com/dzeshiko/sometest** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/dzeshiko/sometest/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/dzeshiko/sometest** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/dzeshiko/sometest/raw/master/.github/makecode/blocks.png)
